...
require_once 'Capt_Error.php';
require_once 'Capt_ActionClass.php';
require_once 'Capt_ActionForm.php';
require_once 'Capt_ViewClass.php';

require_once 'Ethna_Securimage.php';

/**
 *  Capt application Controller definition.
 *
 *  @author     {$author}
 *  @access     public
 *  @package    Capt
 */
class Capt_Controller extends Ethna_Controller
{
    /**#@+
     *  @access private
     */
...
///     return array('ja_JP', 'UTF-8', 'UTF-8');
        return array('en_US', 'UTF-8', 'UTF-8');
    }

    /**
     *  set up default template engine
     *
     *  @access protected
     *  @param  object  Ethna_Renderer renderer object
     *  @obsolete
     */
